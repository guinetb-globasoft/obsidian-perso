...
| **Keep a Changelog** | Format standard de changelog | Pour complétude (changelog projet) |
| **ADR — Nygard (2011)** | Architecture Decision Records | Pour complétude (décisions d'architecture) |
...
- §8 : Exigences pour un système de gestion des records
- §9.4 : Classification
- §9.5 : Indexation
...
### Ce qu'il apporte
- Format Markdown reconnaissable (sections Added/Changed/Deprecated/Removed/Fixed/Security)
- Versionning sémantique aligné avec semver
- Lisible par humain ET par machine

### Quand l'utiliser
Pour challenger la qualité du changelog projet (cf. [[10-Completude-structurelle]]).
...
### Ce que c'est
Pratique formalisée par **Michael Nygard (2011)** dans son article *Documenting Architecture Decisions*. Devenue standard de facto sur les projets IT.

### Ce qu'il apporte
- Format simple : contexte / décision / statut / conséquences
- Décisions **immuables** mais supersedables
- Historique consultable des choix structurants

### Quand l'utiliser
Pour challenger la présence et la qualité des ADR (cf. [[10-Completude-structurelle]]).
...
Clôture projet / livrabilité  → PMBOK / PRINCE2
        ↓
Pratiques IT (ADR, changelog) → Nygard 2011 / Keep a Changelog
```
...
| [[10-Completude-structurelle]] | ISO 15489 §8, R2GA partie II, ADR Nygard, Keep a Changelog |
